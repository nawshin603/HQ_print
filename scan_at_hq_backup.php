<?php
    ...
    $submerchant = "SELECT DISTINCT(name) from tbl_submerchant";
    $submerchantresult = mysqli_query($conn,$submerchant);
       ...
       <div  id="add_data_Modal" class="modal" style="width: auto">
                      ...
                      &nbsp;
                       <p class="animated infinite pulse delay-2s slow" style="font-weight: bold;text-align: center;" id="heading"></p>
                          ...
                          <select class="js-example-basic-single" id="merchants" name="merchants" style="width: 100%" required>
                             ...
                             <br/> 
                             <br>
                          <label for="pick_merchant" id="pick_merchant_label">Pick Merchant Name</label>
                         <div id="kk"> <select class="js-example-basic-single" id="pick_merchant" name="pick_merchant" style="width: 100%" required>
                                <option></option>

                                 <?php 
                                    while($row = mysqli_fetch_array($submerchantresult))
                                    {       
                                          echo "<option value=\"".$row["name"]."\"";
                                          if($_POST['pick_merchant'] == $row['name'])
                                                echo 'selected';
                        ...
                        <!--  <input type="text" name="pick_merchant" id="pick_merchant" class="form-control" required/>   -->
                          <label for="product_qty" id="product_qty_label">Product Quantity</label>  
        ...
        <script type='text/javascript'>
            $('#pickedBarcode').focus();
             ...
             document.getElementById("pick_merchant_label").style.display = "none";
             document.getElementById("product_qty_label").style.display = "none";
            ...
            if (document.getElementById("op2").checked == true)
                  {
                    ...
                    document.getElementById("product_qty").style.display = "block";
                    document.getElementById("pick_merchant_label").style.display = "block";
                    document.getElementById("product_qty_label").style.display = "block";
